...
describe('File Resource', () => {
  ...
  it('should not miss any fields from the sample', (done) => {
    ...
    appTester(App.resources.file.list.operation.perform, bundle)
      .then((results) => {
        ...
        sampleKeys.forEach((sampleKey) => file.hasOwnProperty(sampleKey).should.eql(true));
        done();
      })
      .catch(done);
  });
  ...
  it('should upload a new file in the root dir', (done) => {
    const file = 'https://cdn.zapier.com/storage/files/f6679cf77afeaf6b8426de8d7b9642fc.pdf';
